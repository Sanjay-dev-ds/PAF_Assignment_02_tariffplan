...
<html>
<head>
<link rel="stylesheet" href="Views/TariffPlans.css">
	...
	<div class = " container">
		...
		<h1 style="padding: 10px; background-color: #008AD9; font-weight: bold;" >Tariff-Plan Management</h1>
				 <form id="formPlan" name="formPlan">
					...
					<input class="input" id="tariffPlanId" name="tariffPlanId" type="text" class="form-control form-control-sm"> 
					<br>
					<label for="tariffBlock">Tariff block:</label> 
					<input class="input" id="tariffBlock" name="tariffBlock" type="text" class="form-control form-control-sm"> 
					<br> 
					<label for="unitRate">Unit Rate:</label> 
					<input class="input"  id="unitRate" name="unitRate" type="text" class="form-control form-control-sm"> 
					<br> 
					<label for="fixedCharge">Fixed Charge:</label> 
					<input class="input" id="fixedCharge" name="fixedCharge" type="text" class="form-control form-control-sm"> 
					<br> 
			    	<input class="button" id="btnSave" name="btnSave" type="button" value="Save" class="btn btn-primary"> 
					<input class="input"  type="hidden" id="hidPlanIDSave" name="hidPlanIDSave" value="">
				</form>
					<br>
					<br>
					<br>
